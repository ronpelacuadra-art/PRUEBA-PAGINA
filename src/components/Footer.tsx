...
export default function Footer() {
  return (
    <footer className="bg-neutral-950 border-t border-white/5 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <p className="text-neutral-500 text-sm mt-3">
              Contenido audiovisual con intención
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-white mb-4">Enlaces</h4>
            <div className="space-y-2">
              {["Inicio", "Servicios", "Estudio", "Blog", "Contacto"].map(
                (item) => (
                  <Link
                    key={item}
        ...
        <div className="border-t border-white/5 pt-8 text-center">
          <p className="text-neutral-600 text-sm">
            &copy; {new Date().getFullYear()} Fotolab Studio. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
